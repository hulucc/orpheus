System.register(['angular2/core', 'angular2/router', '../services/router-data', '../charts/date-picker', '../charts/line-selector', '../charts/mode-selector', '../charts/statistic-info', '../charts/statistic-info-detail', '../services/dailyinfo', 'moment'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, router_data_1, date_picker_1, line_selector_1, mode_selector_1, statistic_info_1, statistic_info_detail_1, dailyinfo_1, moment_1;
    ...
    return {
        setters:[
            ...
            function (mode_selector_1_1) {
                mode_selector_1 = mode_selector_1_1;
            },
            function (statistic_info_1_1) {
                statistic_info_1 = statistic_info_1_1;
            },
            function (statistic_info_detail_1_1) {
                statistic_info_detail_1 = statistic_info_detail_1_1;
            },
            ...
            StatPageComponent = (function () {
                ...
                StatPageComponent.prototype.loadQueryParams = function () {
                    ...
                    if (p.mode && p.date && p.lines && p.lineCombination && p.detailDisplay) {
                        this.mode = p.mode;
                        this.date = moment_1.default(p.date);
                ...
                StatPageComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.Router, router_1.RouteParams, router_data_1.RouterDataService, dailyinfo_1.DailyInfoService])
                ], StatPageComponent);
